    ...
    <div :class="classes">
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            <router-link to="/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <object class="bi me-2 ms-4" width="100" height="100" data="/uptime.svg" />
                <span class="fs-4 title">{{ $t("Iftiin Uptime") }}</span>
            </router-link>

            <a v-if="hasNewVersion" target="_blank" href="https://github.com/yd-915/iftiinupkeep/releases" class="btn btn-info me-3">
