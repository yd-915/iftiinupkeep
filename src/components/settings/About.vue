<template>
    <div class="d-flex justify-content-center align-items-center">
        <div class="logo d-flex flex-column justify-content-center align-items-center">
            <object class="my-4" width="200" height="200" data="/uptime.svg" />
            <div class="fs-4 fw-bold">Iftiin Uptime</div>
            ...
            <div class="my-3 update-link"><a href="https://github.com/louislam/uptime-kuma" target="_blank" rel="noopener">{{ $t("Check OG project On GitHub") }}</a></div>
