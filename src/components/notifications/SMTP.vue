<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <input id="from-email" v-model="$parent.notification.smtpFrom" type="text" class="form-control" required autocomplete="false" placeholder="&quot;Iftiin Upkeep&quot; &lt;example@iftiin.help&gt;">
            <div class="form-text">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="to-email" v-model="$parent.notification.smtpTo" type="text" class="form-control" autocomplete="false" placeholder="example@iftiin.help, example@iftiin.help" :required="!hasRecipient">
        </div>
